...
PROJECT_REPO := github.com/AdrianFarmadin/$(PROJECT_NAME)
...
export TERRAFORM_NATIVE_PROVIDER_BINARY := terraform-provider-vault_v3.12.0_x5
...
REGISTRY_ORGS ?= xpkg.upbound.io/adrianfarmadin
IMAGES = $(PROJECT_NAME)
...
XPKG_REG_ORGS ?= xpkg.upbound.io/adrianfarmadin
# NOTE(hasheddan): skip promoting on xpkg.upbound.io as channel tags are
# inferred.
XPKG_REG_ORGS_NO_PROMOTE ?= xpkg.upbound.io/adrianfarmadin
XPKGS = $(PROJECT_NAME)
